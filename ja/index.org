...
安定版 *7.9.2* （2012年9月） --- [[http://orgmode.org/org-7.9.2.tar.gz][tar.gz]] or [[http://orgmode.org/org-7.9.2.zip][zip]]

リリースノートを読む => [[file:Changes.org][release notes]]（英語）

開発版（[[http://orgmode.org/cgit.cgi/org-mode.git/][cgit]]）：

=git://orgmode.org/org-mode.git=

=M-x list-packages RET= (see [[http://orgmode.org/elpa/][Org ELPA]])
