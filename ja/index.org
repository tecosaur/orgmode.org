...
安定版は、バージョン*8.0*です。（2013年04月現在）--- [[http://orgmode.org/org-8.0.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.0.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
