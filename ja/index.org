...
安定版は、バージョン*8.2.7a*です。（2014年06月現在）--- [[http://orgmode.org/org-8.2.7a.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.2.7a.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
