...
安定版は、バージョン*8.3.2*です。（2015年9月現在）--- [[http://orgmode.org/org-8.3.2.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.3.2.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
