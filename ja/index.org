...
安定版は、バージョン*7.9.3f*です。（2013年01月現在）--- [[http://orgmode.org/org-7.9.3f.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-7.9.3f.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
