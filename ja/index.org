...
安定版は、バージョン*8.3.4*です。（2016年2月現在）--- [[http://orgmode.org/org-8.3.4.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.3.4.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
