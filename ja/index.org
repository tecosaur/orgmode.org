...
安定版は、バージョン*8.2.5h*です。（2014年01月現在）--- [[http://orgmode.org/org-8.2.5h.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.2.5h.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
