...
安定版は、バージョン*8.2.8*です。（2014年10月現在）--- [[http://orgmode.org/org-8.2.8.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.2.8.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
