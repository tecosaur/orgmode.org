...
安定版は、バージョン*9.2.5*です。（2019年07月現在）--- [[https://orgmode.org/org-9.2.5.tar.gz][tar.gz]] もしくは [[https://orgmode.org/org-9.2.5.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
