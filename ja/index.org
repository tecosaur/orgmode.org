...
安定版は、バージョン*8.0.4*です。（2013年07月現在）--- [[http://orgmode.org/org-8.0.4.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.0.4.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
