...
安定版は、バージョン*8.3.6*です。（2016年9月現在）--- [[http://orgmode.org/org-8.3.6.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.3.6.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
