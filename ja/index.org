...
安定版は、バージョン*9.1.12*です。（2018年04月現在）--- [[https://orgmode.org/org-9.1.12.tar.gz][tar.gz]] もしくは [[https://orgmode.org/org-9.1.12.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
