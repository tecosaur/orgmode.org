...
安定版は、バージョン*8.2.4*です。（2013年12月現在）--- [[http://orgmode.org/org-8.2.4.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-8.2.4.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
