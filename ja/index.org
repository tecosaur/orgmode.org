...
安定版は、バージョン*9.2.6*です。（2019年09月現在）--- [[https://orgmode.org/org-9.2.6.tar.gz][tar.gz]] もしくは [[https://orgmode.org/org-9.2.6.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
