...
安定版は、バージョン*7.9.3e*です。（2013年01月現在）--- [[http://orgmode.org/org-7.9.3e.tar.gz][tar.gz]] もしくは [[http://orgmode.org/org-7.9.3e.zip][zip]] をダウンロードしてください。 ([[file:../Changes.org][リリースノート（英語）]]を読んでください。)
