...
- <2011-12-12> バージョン 7.8, 7.8.01 and 7.8.02 を公開
...
- <2010-11-25> Org-modeを使うために、熱烈なviユーザが、尊敬に値するEmacsユーザになる時代は終わったかもしれません。Herbert Sitz氏が[[https://github.com/hsitz/VimOrganizer][Vim用の Org-mode クローン]] を作成しています。この[[http://vimeo.com/17182850][ビデオ]] 見ると、今後が楽しみです。
