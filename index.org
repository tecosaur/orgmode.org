...
The current version is 7.6.  To see what has changed in recent releases,
...
Download as [[file:org-7.6.zip][zip file]] or [[file:org-7.6.tar.gz][gzipped tar archive]].  These archives contain
...
** The Org guide and manual
   ...
   - Links below point to the /development version/ of the manual.  If
     ...
     7.6), please browse [[http://orgmode.org/manual/release_7.6/][this directory]].
...
** Worg FAQ and "org-mode" tag on StackOverflow
