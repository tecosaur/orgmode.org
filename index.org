...
The stable version of Org is *8.3.6*, as of Sept. 2016.  See the [[file:Changes.org][release notes]].

You can download it as a [[http://orgmode.org/org-8.3.6.tar.gz][tar.gz]] or [[http://orgmode.org/org-8.3.6.zip][zip]] archive.

Or =M-x package-install RET org RET= (see [[http://orgmode.org/elpa.html][Org ELPA]]).

** Development

You can browse the development version from [[http://orgmode.org/cgit.cgi/org-mode.git/][cgit]]:

=~$ git clone git://orgmode.org/org-mode.git= (or)
=~$ git clone http://orgmode.org/org-mode.git=

You can download the [[http://orgmode.org/org-latest.tar.gz][tar.gz]] or [[http://orgmode.org/org-latest.zip][zip]] archives of daily snapshots.
