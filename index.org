...
<div class="banner hero" itemscope itemtype="https://schema.org/SoftwareApplication">
  ...
  <div>
    ...
    <p>
      A <a href="https://www.gnu.org/software/emacs/" style="color: inherit; font-weight: bold; font-style: italic;">GNU Emacs</a> major mode for <span itemprop="applicationCategory">convenient plain text markup</span> &mdash; and more.</p>
