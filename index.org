...
<div class="banner slim green inline">
  ...
  <a href="https://liberapay.com/bzg" title="Donations always help"
         style="color: #d9b217">
    <img class="inline" src="/resources/img/external/librepay.svg"/>
    LibrePay</a>,
  <a href="https://github.com/sponsors/bzg" title="Donations always help"
     style="color: #222">
    <img class="inline" src="/resources/img/external/github.svg"/>
    GitHub</a>,
  or
  <a href="https://www.paypal.com/paypalme/bzg/10" title="Donations always help"
     style="color: #253b80">
    <img class="inline" src="/resources/img/external/paypal.svg"/>
    PayPal</a></p>
</div>
#+end_export
