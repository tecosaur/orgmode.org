...
The stable version of Org is *9.3*, as of Décember 2019.  See the [[file:Changes.org][release notes]].

Get it with =M-x package-install RET org RET= (see [[https://orgmode.org/elpa.html][Org ELPA]]).

Or download it as a [[https://orgmode.org/org-9.3.tar.gz][tar.gz]] or [[https://orgmode.org/org-9.3.zip][zip]] archives.
