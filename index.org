...
<div class="banner hero" itemscope itemtype="https://schema.org/SoftwareApplication">
  ...
  <div>
    ...
    <p>
      ...
      system.</p>
      <p><a title="Install from ELPA" href="https://elpa.gnu.org/packages/org.html"><img src="https://elpa.gnu.org/packages/org.svg" alt="Install from GNU ELPA" /></a>
	<a title="Report a bug" href="https://orgmode.org/manual/Feedback.html"><img src="/resources/img/badge-report-bug.svg" alt="Report a bug" /></a>
	<a title="How to send feedback" href="https://orgmode.org/manual/Feedback.html"><img src="/resources/img/badge-feedback.svg" alt="How to send feedback" /></a>
