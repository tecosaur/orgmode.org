...
is maintained by <a href="http://lumiere.ens.fr/~guerry/">Bastien Guerry</a> since 2011, with contributions from <a href="http://orgmode.org/org.html#History-and-Acknowledgments">hundreds</a> of users.</span></em></p></div>
#+END_HTML
...
Stable version *7.9.3e* (jan. 2013) --- [[http://orgmode.org/org-7.9.3e.tar.gz][tar.gz]] or [[http://orgmode.org/org-7.9.3e.zip][zip]] ([[file:Changes.org][release notes]]).
