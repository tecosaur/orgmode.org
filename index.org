...
Org is, at heart, a structured plain text file. It has headers, sub-headers, and
keywords that allow it to be easily parsed into agendas and to-do lists.

It is constructed to be simple enough for the novice, yet powerful enough for
the expert.

#+attr_html: :style max-width:45rem
[[file:resources/img/main.svg]]

The syntax is composed of a small collection of simple, yet generic structures. \\
In an editor with rich support for the format, this allows Org to be elegantly
used for a wide variety of purposes.

* Further reading

The latest stable release of Org is *9.3.7*, as of June 2020.
#+begin_center
#+attr_html: :class btn inline
[[file:releases.org][Release notes]]
#+attr_html: :class btn inline
[[https://updates.orgmode.org/][Updates]]
#+end_center

To read a bit more about Org, other than the [[file:quickstart.org][quickstart]] and [[file:manual/index.html][manual]], there's also
a [[file:guide/index.html][guide]], and [[https://orgmode.org/worg/][Worg]] is a wealth of community-written docs.

Once you've used Org for a bit, you'll know it's great --- but did you know it's
...
There's also a mailing list which you can [[https://lists.gnu.org/mailman/listinfo/emacs-orgmode][subscribe]] to, and browse the archives
of ([[https://orgmode.org/list/][main]], [[https://lists.gnu.org/archive/html/emacs-orgmode/][alternative]]).
** Writing about Org
...
+ [[https://www.youtube.com/watch?v=0g9BcZvQbXU][Consistent Technical Documents Using Emacs and Org Mode]] :: Mike Hamrick
