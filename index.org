...
Stable version *8.2.1* (Sept. 2013) --- [[http://orgmode.org/org-8.2.1.tar.gz][tar.gz]] or [[http://orgmode.org/org-8.2.1.zip][zip]] ([[file:Changes.org][release notes]]).
...
#+ATTR_HTML: :alt Rackspace logo :width 200 :float wrap
 [[./img/rackspace.jpg]]
\nbsp{}Thanks to [[http://rackspace.com][Rackspace]] for free hosting of orgmode.org.
