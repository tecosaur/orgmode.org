...
The stable version of Org is *9.1.4*, as of december 2017.  See the [[file:Changes.org][release notes]].

Get it with =M-x package-install RET org RET= (see [[http://orgmode.org/elpa.html][Org ELPA]]).

Or download it as a [[http://orgmode.org/org-9.1.4.tar.gz][tar.gz]] or [[http://orgmode.org/org-9.1.4.zip][zip]] archives.
