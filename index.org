...
The stable version of Org is *9.1.8*, as of March 2018.  See the [[file:Changes.org][release notes]].

Get it with =M-x package-install RET org RET= (see [[https://orgmode.org/elpa.html][Org ELPA]]).

Or download it as a [[https://orgmode.org/org-9.1.7.tar.gz][tar.gz]] or [[https://orgmode.org/org-9.1.7.zip][zip]] archives.
