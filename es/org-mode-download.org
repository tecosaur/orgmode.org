...
* Actual Versión: Org 7.8.06

La actual versión es la 7.8.06. Para ver qué ha cambiado en recientes
...
Descarga un [[file:org-7.8.06.zip][fichero zip]] o un [[file:org-7.8.06.tar.gz][archivo tar comprimido con gz]]. Estos
