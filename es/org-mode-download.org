...
* Actual Versión: Org 7.9

La actual versión es la 7.9. Para ver qué ha cambiado en recientes
...
Descarga un [[file:org-7.9.zip][fichero zip]] o un [[file:org-7.9.tar.gz][archivo tar comprimido con gz]]. Estos
