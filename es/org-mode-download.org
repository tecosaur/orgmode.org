...
* Actual Versión: Org 7.8.08

La actual versión es la 7.8.08. Para ver qué ha cambiado en recientes
...
Descarga un [[file:org-7.8.08.zip][fichero zip]] o un [[file:org-7.8.08.tar.gz][archivo tar comprimido con gz]]. Estos
