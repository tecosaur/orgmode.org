...
* Actual Versión: Org 7.8.07

La actual versión es la 7.8.07. Para ver qué ha cambiado en recientes
...
Descarga un [[file:org-7.8.07.zip][fichero zip]] o un [[file:org-7.8.07.tar.gz][archivo tar comprimido con gz]]. Estos
