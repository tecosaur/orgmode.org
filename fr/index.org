...
Version stable *7.9.2* (sept. 2012) --- [[http://orgmode.org/org-7.9.2.tar.gz][tar.gz]] ou [[http://orgmode.org/org-7.9.2.zip][zip]]
...
=M-x list-packages RET=  (voir [[http://orgmode.org/elpa/][Org ELPA]])
