...
La version stable est la *9.2.6*, septembre 2019.  Voir les ([[file:../Changes.org][changements]]).

Installez avec =M-x package-install RET org RET= (voir [[https://orgmode.org/elpa.html][Org ELPA]]).

Ou téléchargez les archives [[https://orgmode.org/org-9.2.6.tar.gz][tar.gz]] ou [[https://orgmode.org/org-9.2.6.zip][zip]].
