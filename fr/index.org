...
#+BEGIN_HTML
<div style="margin-top:0pt;"><p><em>Org mode permet de prendre des notes,
de maintenir des listes TODO, de planifier des projets et de publier des
documents, le tout à partir de texte brut.<br />

<span style="font-size:70%;">Ce logiciel est développé par <a
...
Voir les [[file:~/install/git/orgweb/Changes.org][derniers changements]] (en).

Version de développement ([[http://orgmode.org/w/org-mode.git][gitweb]]):
...
Voir les [[http://orgmode.org/worg/doc.html][docs]] de référence sur les commands et les options d'Org.
