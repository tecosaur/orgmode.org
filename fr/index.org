...
<div class="banner hero" itemscope itemtype="https://schema.org/SoftwareApplication">
  ...
  <div>
    ...
    <p>
      Un mode majeur de <a href="https://www.gnu.org/software/emacs/" style="color: inherit; font-weight: bold; font-style: italic;">GNU Emacs</a> pour <span itemprop="applicationCategory">format de balisage léger et pratique</span> et bien plus.</p>
