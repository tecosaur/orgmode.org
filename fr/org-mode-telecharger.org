...
* Version actuelle : Org 7.8

La version actuelle est la version 7.8.  Pour voir les changements 
récents, lisez la liste détaillée des [[http://orgmode.org/Changes.org][modifications]] (en anglais).
...
Télécharger Org comme [[http://orgmode.org/org-7.6.zip][fichier zip]] ou comme [[http://orgmode.org/org-7.6.tar.gz][archive tar gzippée]].  Ces
