...
* Version actuelle : Org 7.8.02

La version actuelle est la version 7.8.02.  Pour voir les changements
...
Télécharger Org comme [[http://orgmode.org/org-7.8.02.zip][fichier zip]] ou comme [[http://orgmode.org/org-7.8.02.tar.gz][archive tar gzippée]].  Ces
