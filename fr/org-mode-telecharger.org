...
* Version actuelle : Org 7.8.10

La version actuelle est la version 7.8.10.  Pour voir les changements
...
Télécharger Org comme [[http://orgmode.org/org-7.8.10.zip][fichier zip]] ou comme [[http://orgmode.org/org-7.8.10.tar.gz][archive tar gzippée]].  Ces
