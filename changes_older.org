#+title:  Org mode for Emacs -- Older (!) Release notes
...
Full credit goes to Brad Bozarth who really [[https://orgmode.org/list/f47cd1b50903220338g79cb0d32gcef1c4496b243aac@mail.gmail.com][paved the way]] for this exciting
new feature.
...
See [[https://orgmode.org/list/877i2g53px.fsf@fastmail.fm][this mailing list thread]] for context.
...
This new feature resulted from a [[https://orgmode.org/list/87tz5aq48u.fsf@fastmail.fm][discussion]] with Matt Lundin and Bernt
Hansen.
...
This is in response to a [[https://orgmode.org/list/87ocwjzts2.fsf@CPU107.opentrends.net][thread on the mailing list]], started by Daniel
...
However, as John Rakestraw has [[https://orgmode.org/list/20090201154424.2c07d9ff@johnrakestraw.com][pointed out]], if the blocking is done by
