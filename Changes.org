...
***  It is now possible to have links within inlined footnotes.
...
*** Optionally variable names in code block calls
...
*** New =org-export-latex-timestamp-inactive-markup= variable
