...
- The default value of [[doc::org-table-number-regexp][org-table-number-regexp]] now allows commas as the
  mark to separate decimals from integers in numbers.  If your code relies
  on the previous behavior, please customize this variable.  See the
