...
- If your code relies on =org-write-agenda=, use
...
Embedded javascript code is now licensed under GPLv3 (or later),
the copyright is owned by the Free Software Foundation, Inc.
...
adapt the code and license to your needs.
