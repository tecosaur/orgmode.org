...
*** New escape sequence =%F= for capture templates
...
*** New variable =org-list-indent-offset=
...
*** New variable =org-agenda-bulk-custom-functions= for custom bulk functions
...
*** New function =org-clock-remove-empty-clock-drawer=
...
*** New variable =org-export-latex-quotes= to customize quotes in LaTeX export
...
*** New variable =org-export-html-before-content-div=
...
*** New variable =org-lparse-use-flashy-warning= defaulting to =nil=

Flashy and verbose warnings while exporting to ODT have been
disabled.  Set this to =t= if you want it back.

*** Babel now supports [[http://fomus.sourceforge.net/][fomus]] language

=ob-fomus.el= has been added to =contrib/langs/=.
