...
You can now use =git-annex= together with Org attachements.
...
Org will assume your first refile action will end up in the current file,
unless you complete with another file/headline.

*** When you cannot change the TODO state of a task, Org displays the blocking task

This is useful to quickly see what task is blocking the task you want to
update.
