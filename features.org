...
link type to the document so that ~[[issue:74][version mismatch]]~
expands to =https://github.com/author/repo/issues/74=.

Beyond expanding links, you can define custom resolving functions,
link to files on remote machines with
[[https://www.emacswiki.org/emacs/TrampMode][Tramp]], and more.
...
Org is available on mobile devices, so you never have to miss a note.

For iOS there is the wonderful [[https://beorgapp.com/][beorg]], which
supports many of Org's features and can sync over a variety of
services.

For Android there is the excellent and open source [[http://www.orgzly.com/][orgzly]],
...
You can host the app yourself or access a version hosted at https://organice.200ok.ch/.
