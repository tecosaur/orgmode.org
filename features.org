...
whole trees with single keystroke -- =tab=.  Org's foldable trees make
for quick, graceful navigation and powerful information hiding that
lets you focus on the task at hand without compromising the ability to
get the information you need complete it.
...
Org is an authoring and publishing tool -- it functions as everything
from a static site generator, to a suite of tools for self-publishing.
...
With /agenda views/ --- reports generated from your /TODO items/ ---
you can see your tasks on a daily, weekly, and monthly basis.
...
and at end of the day, you can generate customized reports about how
you spent your time.
...
To give only a single example beyond those already mentioned, consider
hyperlinks.  While updating docs for a project you find yourself
repeatedly linking to GitHub issues. In Org you can add a new ~issue:~
link type to the document (or globally if you prefer) so that
~[[issue:74][version mismatch]]~ expands to
