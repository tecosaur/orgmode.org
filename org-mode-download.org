...
* Current Version: Org 7.9

The current version is 7.9.  To see what has changed in recent releases,
...
Download as [[file:org-7.9.zip][zip file]] or [[file:org-7.9.tar.gz][gzipped tar archive]].  These archives contain both
