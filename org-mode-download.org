...
* Current Version: Org 7.8.07

The current version is 7.8.07.  To see what has changed in recent releases,
...
Download as [[file:org-7.8.07.zip][zip file]] or [[file:org-7.8.07.tar.gz][gzipped tar archive]].  These archives contain both
