...
* Current Version: Org 7.8.02

The current version is 7.8.02.  To see what has changed in recent releases,
...
Download as [[file:org-7.8.02.zip][zip file]] or [[file:org-7.8.02.tar.gz][gzipped tar archive]].  These archives contain both
