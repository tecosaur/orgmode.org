...
* Current Version: Org 7.8.05

The current version is 7.8.05.  To see what has changed in recent releases,
...
Download as [[file:org-7.8.05.zip][zip file]] or [[file:org-7.8.05.tar.gz][gzipped tar archive]].  These archives contain both
