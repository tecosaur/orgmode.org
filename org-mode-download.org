...
* Current Version: Org 7.8.08

The current version is 7.8.08.  To see what has changed in recent releases,
...
Download as [[file:org-7.8.08.zip][zip file]] or [[file:org-7.8.08.tar.gz][gzipped tar archive]].  These archives contain both
