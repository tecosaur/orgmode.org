...
The current version is 7.8.10.  To see what has changed in recent releases,
...
Download as [[file:org-7.8.10.zip][zip file]] or [[file:org-7.8.10.tar.gz][gzipped tar archive]].  These archives contain both
