...
You can start writing Org syntax in any plaintext editor, however to see what
makes it /great,/ one really needs to *[[file:install.org][install]]* an editor with rich support.
